...
public class LogAnalysisMLP {
    ...
    public static void main(String[] args) throws Exception {
        ...
        rr.initialize(new FileSplit(new File("src/main/resources/logAnalysis/taining.csv")));
        DataSetIterator trainIter = new RecordReaderDataSetIterator(rr,batchSize,5,numOutputs);
//        rr.initialize(new FileSplit(new File("src/main/resources/logAnalysis/iris1.csv")));
//        DataSetIterator trainIter = new RecordReaderDataSetIterator(rr,batchSize,4,numOutputs);

        //Load the test/evaluation data:
        RecordReader rrTest = new CSVRecordReader();
        rrTest.initialize(new FileSplit(new File("src/main/resources/logAnalysis/testing.csv")));
        DataSetIterator testIter = new RecordReaderDataSetIterator(rrTest,batchSize,5,numOutputs);
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
            ...
            .layer(0, new DenseLayer.Builder().nIn(numInputs).nOut(numHiddenNodes)
                .build())
            .layer(1, new DenseLayer.Builder().nIn(numHiddenNodes).nOut(numHiddenNodes).weightInit(WeightInit.XAVIER).activation("relu")
                .build())
...
//                DataSet m = trainIter.next();
//                preProcessor.transform(m);
//                model.fit(m);
//            }
