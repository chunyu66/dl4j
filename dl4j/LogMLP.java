...
public class LogMLP {
    ...
    private static Logger log = LoggerFactory.getLogger(LogMLP.class);
    ...
    public static void main(String[] args) throws  Exception {
        ...
        recordReader.initialize(new FileSplit(new ClassPathResource("logData.txt").getFile()));
        ...
        int numClasses = 19;     //3 classes (types of iris flowers) in the iris data set. Classes have integer values 0, 1 or 2
